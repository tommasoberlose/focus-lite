...
public class PageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.page_develop, container, false);
        String version = "";
        try {
            version = " " + getString(R.string.text_version) + getActivity().getPackageManager().getPackageInfo(getActivity().getPackageName(), 0).versionName;
        } catch (Exception e) {

        }
        ((TextView) view.findViewById(R.id.title_version)).setText(getString(R.string.app_name) + version);


        view.findViewById(R.id.action_open_focus).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(R.id.action_rate_app).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
        ...
        view.findViewById(R.id.action_gift_cafe).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    IabHelper.QueryInventoryFinishedListener
        ...
        public void onQueryInventoryFinished(IabResult result, Inventory inventory)
        {
            ...
            if (!inventory.hasPurchase(SKU_COFFEE)) {
                mHelper.launchPurchaseFlow(getActivity(), SKU_COFFEE, RC_REQUEST,
